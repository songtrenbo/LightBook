                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            // ),
                            child: InkWell(
                              onTap: () => AuthMethods().signUpUser(email: email, password: password, username: username, name: name),
                              child: Container(
                                child: const Text('Đăng ký'),
                                width: double.infinity,
                                alignment: Alignment.center,
                                padding: const EdgeInsets.symmetric(vertical: 12),
                                decoration: const ShapeDecoration(shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0))));
                              ),
                            )
                          ),
                          SizedBox(
